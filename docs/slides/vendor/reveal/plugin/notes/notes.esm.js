...
const n = /[&<>"']/,
  ...
  o = (t) => a[t];
function l(t, e) {
  if (e) { if (n.test(t)) return t.replace(i, o); }
...
function m(t, e, n) {
  if (t) {
    ...
    if (
      0 === t.indexOf("javascript:") || 0 === t.indexOf("vbscript:") ||
      0 === t.indexOf("data:")
    ) return null;
  }
...
class _ {
  ...
  blockquote(t) {
    ...
    if (e) {
      const t = e[0].replace(/^ *>[ \t]?/gm, ""), n = this.lexer.state.top;
  ...
  list(t) {
    ...
    if (e) {
      ...
      for (; t && (h = !1, e = k.exec(t)) && !this.rules.block.hr.test(t);) {
        if (
          n = e[0],
  ...
  def(t) {
    ...
    if (e) {
      const t = e[1].toLowerCase().replace(/\s+/g, " "),
        n = e[2]
          ? e[2].replace(/^<(.*)>$/, "$1").replace(
            this.rules.inline._escapes,
            "$1",
          )
          : "",
        i = e[3]
          ? e[3].substring(1, e[3].length - 1).replace(
            this.rules.inline._escapes,
            "$1",
          )
          : e[3];
      ...
      return !this.lexer.state.inLink && /^<a /i.test(e[0])
            ...
            (this.lexer.state.inRawBlock = !1),
        {
          ...
          text: this.options.sanitize
            ? this.options.sanitizer ? this.options.sanitizer(e[0]) : l(e[0])
            : e[0],
        };
    }
  }
  link(t) {
    ...
    if (e) {
      ...
      return n = n.trim(),
        /^</.test(n) &&
        (n = this.options.pedantic && !/>$/.test(t)
          ? n.slice(1)
          : n.slice(1, -1)),
        T(
          e,
  ...
  codespan(t) {
    ...
    if (e) {
      let t = e[2].replace(/\n/g, " ");
      const n = /[^ ]/.test(t), i = /^ /.test(t) && / $/.test(t);
    ...
    if (n) {
      ...
      return t = this.lexer.state.inRawBlock
        ? this.options.sanitize
          ? this.options.sanitizer ? this.options.sanitizer(n[0]) : l(n[0])
          : n[0]
...
z.def = d(z.def).replace("label", z._label).replace("title", z._title)
  .getRegex(),
  z.bullet = /(?:[*+-]|\d{1,9}[.)])/,
  z.listItemStart = d(/^( *)(bull) */).replace("bull", z.bullet).getRegex(),
  z.list = d(z.list).replace(/bull/g, z.bullet).replace(
    "hr",
    "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))",
  ...
  z._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/,
  z.html = d(z.html, "i").replace("comment", z._comment).replace("tag", z._tag)
    .replace(
      "attribute",
      / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/,
    ).getRegex(),
  z.paragraph = d(z._paragraph).replace("hr", z.hr).replace(
    "heading",
    " {0,3}#{1,6} ",
  ...
  z.gfm.table = d(z.gfm.table).replace("hr", z.hr).replace(
    "heading",
    " {0,3}#{1,6} ",
  ...
  z.gfm.paragraph = d(z._paragraph).replace("hr", z.hr).replace(
    "heading",
    " {0,3}#{1,6} ",
  ).replace("|lheading", "").replace("table", z.gfm.table).replace(
    "blockquote",
    " {0,3}>",
  ).replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(
    "list",
  ...
  z.pedantic = {
    ...
    html: d(
      "^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))",
    ).replace("comment", z._comment).replace(
      /tag/g,
    ...
    fences: b,
    lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
    paragraph: d(z.normal._paragraph).replace("hr", z.hr).replace(
      "heading",
      " *#{1,6} *[^\n]",
    ).replace("lheading", z.lheading).replace("blockquote", " {0,3}>").replace(
      "|fences",
      "",
...
$._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~",
  $.punctuation = d($.punctuation).replace(/punctuation/g, $._punctuation)
    .getRegex(),
  $.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g,
  $.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g,
  $._comment = d(z._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
  $.emStrong.lDelim = d($.emStrong.lDelim).replace(/punct/g, $._punctuation)
    .getRegex(),
  $.emStrong.rDelimAst = d($.emStrong.rDelimAst, "g").replace(
    /punct/g,
    $._punctuation,
  ).getRegex(),
  $.emStrong.rDelimUnd = d($.emStrong.rDelimUnd, "g").replace(
    /punct/g,
    $._punctuation,
  ).getRegex(),
  $._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,
  ...
  $.autolink = d($.autolink).replace("scheme", $._scheme).replace(
    "email",
    $._email,
  ).getRegex(),
  $._attribute =
    /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
  $.tag = d($.tag).replace("comment", $._comment).replace(
    "attribute",
    $._attribute,
  ).getRegex(),
  $._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
  $._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/,
  $._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
  $.link = d($.link).replace("label", $._label).replace("href", $._href)
    .replace("title", $._title).getRegex(),
  $.reflink = d($.reflink).replace("label", $._label).replace("ref", z._label)
    .getRegex(),
  $.nolink = d($.nolink).replace("ref", z._label).getRegex(),
  $.reflinkSearch = d($.reflinkSearch, "g").replace("reflink", $.reflink)
    .replace("nolink", $.nolink).getRegex(),
  $.normal = { ...$ },
  $.pedantic = {
    ...$.normal,
    strong: {
    ...
    reflink: d(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", $._label)
      .getRegex(),
  },
  $.gfm = {
    ...$.normal,
  ...
  $.gfm.url = d($.gfm.url, "i").replace("email", $.gfm._extended_email)
    .getRegex(),
  $.breaks = {
    ...$.gfm,
...
class R {
    ...
    for (
      ...
      if (
        ...
        if (n = this.tokenizer.space(t)) {
          ...
          if (
            s = t, this.options.extensions && this.options.extensions.startBlock
          ) {
            let e = 1 / 0;
            const n = t.slice(1);
            let i;
  ...
  inlineTokens(t, e = []) {
      ...
      if (t.length > 0) {
        for (
          ...
          t.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) &&
            (l = l.slice(0, r.index) + "[" + S("a", r[0].length - 2) + "]" +
    ...
    for (; null != (r = this.tokenizer.rules.inline.escapedEmSt.exec(l));) {
      l = l.slice(0, r.index + r[0].length - 2) + "++" +
    ...
    for (; t;) {
      if (
        ...
        if (n = this.tokenizer.escape(t)) {
          ...
          t = t
            .substring(n.raw.length), e.push(n);
          ...
          this.state.inLink || !(n = this.tokenizer.url(t, A))
        ) {
          if (
            s = t,
...
class L {
  ...
  code(t, e, n) {
    ...
    return t = t.replace(/\n$/, "") + "\n",
      i
        ? '<pre><code class="' + this.options.langPrefix + l(i) + '">' +
          (n ? t : l(t, !0)) + "</code></pre>\n"
...
class M {
  ...
  serialize(t) {
    return t.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi, "").replace(
      /[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,
      "",
    ).replace(/\s/g, "-");
  }
                  ...
                  m
                    ? k.tokens.length > 0 && "paragraph" === k.tokens[0].type
                      ? (k.tokens[0].text = b + " " + k.tokens[0].text,
                        k.tokens[0].tokens && k.tokens[0].tokens.length > 0 &&
                        "text" === k.tokens[0].tokens[0].type &&
                        (k.tokens[0].tokens[0].text = b + " " +
...
function P(t, e) {
  return (n, i, s) => {
      ...
      a = function (t, e, n) {
        return (i) => {
          if (
            ...
            const t = "<p>An error occurred:</p><pre>" + l(i.message + "", !0) +
              "</pre>";
    ...
    if (
      ...
      let c = 0;
      return O.walkTokens(o, function (t) {
        "code" === t.type && (c++,
          setTimeout(() => {
    ...
    if (i.async) {
      return Promise.resolve(i.hooks ? i.hooks.preprocess(n) : n).then(
        (e) => t(e, i),
      ).then((t) =>
        i.walkTokens
        ...
        (t) => i.hooks ? i.hooks.postprocess(t) : t,
      ).catch(a);
    }
    try {
      ...
      if (
        n.async = O.defaults.async || n.async || !1,
          t.extensions && (t.extensions.forEach((t) => {
            ...
            if (t.tokenizer) {
              if (
                !t.level || "block" !== t.level && "inline" !== t.level
              ) {
              ...
              e[t.level]
                ...
                t.start && ("block" === t.level
                  ? e.startBlock
                    ? e.startBlock.push(t.start)
                    : e.startBlock = [t.start]
                  : "inline" === t.level && (e.startInline
      ...
      if (t.hooks) {
        ...
        for (const n in t.hooks) {
          ...
          q.passThroughHooks.has(n)
            ? e[n] = (s) => {
              if (O.defaults.async) {
                return Promise.resolve(t.hooks[n].call(e, s)).then(
                  (t) => i.call(e, t),
                );
              }
    ...
    for (const i of t) {
      switch (n = n.concat(e.call(O, i)), i.type) {
        ...
        case "list":
          ...
          break;
        default:
          O.defaults.extensions && O.defaults.extensions.childTokens &&
  ...
  function i() {
    if (n && !n.closed) n.focus();
      ...
      !function () {
        ...
        }, 500), window.addEventListener("message", r);
      }();
    }
  }
  function s(t) {
    ...
    if (
      ...
      (a.notes = i.getAttribute("data-notes"), a.whitespace = "pre-wrap"), r
    ) {
    ...
    if (
      ...
      try {
        ...
        s && "reveal-notes" === s.namespace && "connected" === s.type
          ? (clearInterval(t), a())
          : s && "reveal-notes" === s.namespace && "call" === s.type &&
            function (t, i, s) {
              let r = e[t].apply(e, i);
              n.postMessage(
                JSON.stringify({
        ...
        (null !== window.location.search.match(/(\?|\&)notes/gi)
          ...
          : window.addEventListener("message", (t) => {
            if (!n && "string" == typeof t.data) {
              ...
              i && "reveal-notes" === i.namespace && "heartbeat" === i.type &&
                (e = t.source,
                  n && !n.closed
                    ? n.focus()
