...
const e = (e, t) => {
  ...
  o = (e) => {
    let t = (e = e || document.documentElement).requestFullscreen ||
  ...
  u = /(iphone|ipod|ipad|android)/gi.test(h) ||
    ...
    var t = function (e) {
      ...
      d = function (e) {
        e.availableWidth = e.element.parentNode.clientWidth,
          ...
          e.whiteSpace = e.multiLine && e.currentFontSize === e.minSize
            ? "normal"
            : "nowrap";
      },
      c = function (e) {
      ...
      h = function (t) {
        ...
        return t.currentFontSize = parseFloat(i.getPropertyValue("font-size")),
      ...
      u = function (e) {
        var t = !1;
        return !e.preStyleTestCompleted &&
...
class p {
  ...
  load(e, i = {}) {
    e.style.display = this.Reveal.getConfig().display,
      t(e, "img[data-src], video[data-src], audio[data-src], iframe[data-src]")
        .forEach((e) => {
    ...
    if (s) {
      ...
      if (!1 === s.hasAttribute("data-loaded")) {
        ...
        if (n) {
          /^data:/.test(n.trim())
            ...
            : t.style.backgroundImage = n.split(",").map((e) =>
              `url(${
                ((e = "") =>
                  encodeURI(e).replace(/%5B/g, "[").replace(/%5D/g, "]")
                    .replace(
                      /[!'()*]/g,
      ...
      n && this.shouldPreload(s) && !/autoplay=(1|true|yes)/gi.test(a) &&
        n.getAttribute("src") !== a && n.setAttribute("src", a);
    }
    this.layout(e);
  }
  layout(e) {
  ...
  formatEmbeddedContent() {
    let e = (e, i, s) => {
      t(this.Reveal.getSlidesElement(), "iframe[" + e + '*="' + i + '"]')
        .forEach((t) => {
    ...
    if (e) {
      ...
      t(e, 'img[src$=".gif"]').forEach((e) => {
        ...
        t(e, "video, audio").forEach((e) => {
          ...
          if (
            "boolean" != typeof t &&
            (t = e.hasAttribute("data-autoplay") ||
              !!r(e, ".slide-background")), t && "function" == typeof e.play
          ) {
            if (i && !e.muted) return;
            if (e.readyState > 1) this.startEmbeddedMedia({ target: e });
            else if (u) {
              let t = e.play();
              t && "function" == typeof t.catch && !1 === e.controls &&
                t.catch(() => {
                  e.controls = !0,
  ...
  startEmbeddedMedia(e) {
    ...
    t && i && (e.target.paused || e.target.ended) &&
  ...
  stopEmbeddedContent(i, s = {}) {
    s = e({ unloadIframes: !0 }, s),
      i && i.parentNode && (t(i, "video, audio").forEach((e) => {
        e.hasAttribute("data-ignore") || "function" != typeof e.pause ||
        ...
        t(i, 'iframe[src*="youtube.com/embed/"]').forEach((e) => {
          !e.hasAttribute("data-ignore") && e.contentWindow &&
...
class w {
  ...
  configure(e, t) {
    let i = "none";
    e.slideNumber && !this.Reveal.isPrintView() &&
    ("all" === e.showSlideNumber ||
      "speaker" === e.showSlideNumber && this.Reveal.isSpeakerNotes()) &&
    (i = "block"), this.element.style.display = i;
  }
  update() {
    this.Reveal.getConfig().slideNumber && this.element &&
  ...
  getSlideNumber(e = this.Reveal.getCurrentSlide()) {
    ...
    if ("function" == typeof i.slideNumber) t = i.slideNumber(e);
      ...
      "string" == typeof i.slideNumber && (s = i.slideNumber),
        /c/.test(s) || 1 !== this.Reveal.getHorizontalSlides().length ||
        (s = "c");
...
class E {
  ...
  jump() {
    ...
    let e, t = this.jumpInput.value.trim("");
    if (/^\d+$/.test(t)) {
...
class R {
  ...
  createBackground(e, t) {
    ...
    i.className = "slide-background " +
      e.className.replace(/present|past|future/, "");
    let s = document.createElement("div");
    return s.className = "slide-background-content",
      i.appendChild(s),
      t.appendChild(i),
  ...
  sync(e) {
    ...
    e.classList.remove("has-dark-background"),
      ...
      (s.background || s.backgroundColor || s.backgroundGradient ||
        s.backgroundImage || s.backgroundVideo || s.backgroundIframe) &&
      t.setAttribute(
        "data-background-hash",
        s.background + s.backgroundSize + s.backgroundImage +
          s.backgroundVideo + s.backgroundIframe + s.backgroundColor +
          s.backgroundGradient + s.backgroundRepeat + s.backgroundPosition +
          s.backgroundTransition + s.backgroundOpacity,
      ),
      s.backgroundSize &&
  ...
  getContrastClass(e) {
    ...
    if (i) {
      const e = S(i);
      if (e && 0 !== e.a) {
        return "string" == typeof (s = i) && (s = S(s)),
    ...
    if (
      Array.from(this.element.childNodes).forEach((i, s) => {
        i.classList.remove("past", "present", "future"),
          ...
          (e || s === a.h) && t(i, ".slide-background").forEach((e, t) => {
        ...
        this.previousBackground && !this.previousBackground.closest("body") &&
  ...
  updateParallax() {
    ...
    if (this.Reveal.getConfig().parallaxBackgroundImage) {
      ...
      let r, o, l = this.element.offsetWidth, d = s.length;
      r =
        "number" == typeof this.Reveal.getConfig().parallaxBackgroundHorizontal
          ...
          ? (t - l) / (d - 1)
          : 0, o = r * e.h * -1;
      let c, h, u = this.element.offsetHeight, g = a.length;
...
class k {
  ...
  run(e, t) {
    ...
    if (
      e && t && e.hasAttribute("data-auto-animate") &&
      ...
      let r = this.getAutoAnimatableElements(e, t).map(
        (e) => this.autoAnimateElements(e.from, e.to, e.options || {}, i, A++),
      );
      if (
  ...
  reset() {
    t(
      ...
      this.autoAnimateStyleSheet && this.autoAnimateStyleSheet.parentNode &&
  ...
  autoAnimateElements(e, t, i, s, a) {
    ...
    if (d.length > 0) {
      r.styles.transition = "none",
        ...
        l = '[data-auto-animate-target="' + a + '"] {' +
          Object.keys(r.styles).map(
            (e) => e + ": " + r.styles[e] + " !important;",
          ).join("") +
          '}[data-auto-animate="running"] [data-auto-animate-target="' + a +
          '"] {' + Object.keys(o.styles).map((e) =>
            e + ": " + o.styles[e] + " !important;"
          ).join("") +
          "}";
    }
    return l;
  ...
  getAutoAnimateOptions(t, i) {
    ...
    return t.dataset.autoAnimateEasing &&
  ...
  getAutoAnimatableElements(e, t) {
    let i =
        ("function" == typeof this.Reveal.getConfig().autoAnimateMatcher
          ...
          : this.getAutoAnimatePairs).call(this, e, t),
      s = [];
    return i.filter((e, t) => {
  ...
  getAutoAnimatePairs(e, t) {
    ...
    return this.findAutoAnimateMatches(
      i,
      e,
      t,
      "[data-id]",
      ...
      i.forEach((e) => {
        n(e.from, s) ? e.options = { scale: !1 } : n(e.from, "pre") &&
    ...
    [].slice.call(t.querySelectorAll(s)).forEach((e, t) => {
      ...
      [].slice.call(i.querySelectorAll(s)).forEach((t, i) => {
        ...
        if (o[s] = o[s] || [], o[s].push(t), r[s]) {
          const e = o[s].length - 1, t = r[s].length - 1;
          r[s][e]
            ? (l = r[s][e], r[s][e] = null)
  ...
  getUnmatchedAutoAnimateElements(e) {
    return [].slice.call(e.children).reduce((e, t) => {
      ...
      return t.hasAttribute("data-auto-animate-target") || i || e.push(t),
...
class L {
    ...
    const d = (e, t, i, n) => {
      ...
      if (l && this.Reveal.shouldAutoAnimateBetween(l, e)) {
        ...
        if (e.className = "scroll-page", r.push(e), n && s.length > t) {
          const i = s[t], n = window.getComputedStyle(i);
          n && n.background
  ...
  toggle(e) {
    "boolean" == typeof e
      ? e ? this.activate() : this.deactivate()
      : this.isActive()
      ? this.deactivate()
      : this.activate();
  }
  ...
  syncPages() {
    ...
    this.pages = o.map((i) => {
      ...
      o += n.autoAnimatePages.reduce(
        ...
        n.pageElement.querySelectorAll(".scroll-snap-point").forEach(
          (e) => e.remove(),
        );
      for (let e = 0; e < o + 1; e++) {
      ...
      return s && n.scrollTriggers.length > 0
        ? (n.pageHeight = a,
        ...
        o > 0
          ? (n.stickyElement.style.position = "sticky",
            n.stickyElement.style.top = Math.max((a - n.pageHeight) / 2, 0) +
              "px")
          : (n.stickyElement.style.position = "relative",
            n.pageElement.style.scrollSnapAlign = n.pageHeight < a
              ? "center"
              : "start"),
        n;
    }),
    ...
    e.autoAnimateElements.length > 0 &&
      this.slideTriggers.push(
        ...Array.from(e.autoAnimateElements).map((t, i) => {
          ...
          return this.createFragmentTriggersForPage(s, s.slideElement),
  ...
  syncProgressBar() {
    this.progressBarInner.querySelectorAll(".scrollbar-slide").forEach(
      (e) => e.remove(),
    );
    ...
    this.progressBarHeight = this.progressBarInner.offsetHeight,
      ...
      this.progressBarScrollableHeight = this.progressBarHeight -
        this.playheadHeight;
    const s = t / e * this.progressBarHeight, a = Math.min(s / 8, 4);
      ...
      s > 6
        ? this.slideTriggers.forEach((e) => {
          ...
          t.progressBarSlide = document.createElement("div"),
            ...
            t.progressBarSlide.style.top = e.range[0] * this.progressBarHeight +
              "px",
            ...
            t.scrollTriggerElements = t.scrollTriggers.map((i, s) => {
              ...
              return n.className = "scrollbar-trigger",
                n.style.top =
                  (i.range[0] - e.range[0]) * this.progressBarHeight + "px",
                n.style.height =
                  (i.range[1] - i.range[0]) * this.progressBarHeight - a + "px",
  ...
  setProgressBarValue(e) {
    this.progressBar &&
      (this.progressBarPlayhead.style.transform = `translateY(${
        ...
        this.getAllPages().filter((e) => e.progressBarSlide).forEach((e) => {
  ...
  scrollToSlide(e) {
    if (this.active) {
      ...
      t &&
        (this.viewportElement.scrollTop = t.range[0] *
          (this.viewportElement.scrollHeight -
            this.viewportElement.offsetHeight));
  ...
  restoreScrollPosition() {
    ...
    e && t === location.origin + location.pathname &&
  ...
  activatePage(e) {
    if (!e.active) {
      ...
      s.style.display = "block",
        ...
        Array.from(s.parentNode.querySelectorAll(".scroll-page-content"))
          .forEach((e) => {
...
class x {
  ...
  update(e, t, i = this.Reveal.getCurrentSlide()) {
    let s = { shown: [], hidden: [] };
    if (
      i && this.Reveal.getConfig().fragments &&
  ...
  goto(e, t = 0) {
    ...
    if (i && this.Reveal.getConfig().fragments) {
      ...
      if (s.length) {
        ...
        return this.Reveal.controls.update(),
...
class P {
  ...
  activate() {
    if (
      this.Reveal.getConfig().overview && !this.Reveal.isScrollView() &&
      !this.isActive()
    ) {
      this.active = !0,
  ...
  layout() {
    this.Reveal.getHorizontalSlides().forEach((e, i) => {
      e.setAttribute("data-index-h", i),
        ...
        e.classList.contains("stack") && t(e, "section").forEach((e, t) => {
          e.setAttribute("data-index-h", i),
...
class T {
  ...
  onDocumentKeyDown(e) {
    ...
    if (
      "function" == typeof t.keyboardCondition && !1 === t.keyboardCondition(e)
    ) return !0;
    ...
    let a = document.activeElement &&
      ...
      n = document.activeElement && document.activeElement.tagName &&
        /input|textarea/i.test(document.activeElement.tagName),
      r = document.activeElement && document.activeElement.className &&
        /speaker-notes/i.test(document.activeElement.className),
      l = !(-1 !== [32, 37, 38, 39, 40, 63, 78, 80, 191].indexOf(e.keyCode) &&
          e.shiftKey || e.altKey) &&
        (e.shiftKey || e.altKey || e.ctrlKey || e.metaKey);
    if (a || n || r || l) return;
    let d, c = [66, 86, 190, 191, 112];
    ...
    let h = "linear" === t.navigationMode ||
        !this.Reveal.hasHorizontalSlides() || !this.Reveal.hasVerticalSlides(),
      u = !1;
    if ("object" == typeof t.keyboard) {
      for (d in t.keyboard) {
        if (parseInt(d, 10) === i) {
          ...
          "function" == typeof i
            ? i.apply(null, [e])
            : "string" == typeof i && "function" == typeof this.Reveal[i] &&
              this.Reveal[i].call(), u = !0;
        }
      }
    }
    if (!1 === u) {
      for (d in this.bindings) {
        if (parseInt(d, 10) === i) {
          ...
          "function" == typeof t
            ? t.apply(null, [e])
            : "string" == typeof t && "function" == typeof this.Reveal[t] &&
              this.Reveal[t].call(), u = !0;
        }
      }
    }
    !1 === u &&
    (u = !0,
      80 === i || 33 === i
        ...
        ? 112 === i ? this.Reveal.toggleHelp() : u = !1
        : this.Reveal.toggleHelp()),
      u ? e.preventDefault && e.preventDefault() : 27 !== i && 79 !== i ||
    ...
    }
    {
      ...
      /\/[-\d]+$/g.test(i) &&
        (t = parseInt(i.split("/").pop(), 10),
          ...
          i = i.split("/").shift());
      try {
        e = document.getElementById(decodeURIComponent(i)).closest(
          ".slides section",
        );
      } catch (e) {}
    ...
    g && (e = ["touchstart"]),
      e.forEach((e) => {
        this.controlsLeft.forEach(
          (t) => t.addEventListener(e, this.onNavigateLeftClicked, !1),
        ),
          this.controlsRight.forEach(
            (t) => t.addEventListener(e, this.onNavigateRightClicked, !1),
          ),
          this.controlsUp.forEach(
            (t) => t.addEventListener(e, this.onNavigateUpClicked, !1),
          ),
          this.controlsDown.forEach(
            (t) => t.addEventListener(e, this.onNavigateDownClicked, !1),
          ),
          this.controlsPrev.forEach(
            (t) => t.addEventListener(e, this.onNavigatePrevClicked, !1),
          ),
          this.controlsNext.forEach(
            (t) => t.addEventListener(e, this.onNavigateNextClicked, !1),
          ),
          this.controlsFullscreen.forEach(
            (t) => t.addEventListener(e, this.onEnterFullscreen, !1),
          );
      });
  }
  unbind() {
    ["touchstart", "click"].forEach((e) => {
      this.controlsLeft.forEach(
        (t) => t.removeEventListener(e, this.onNavigateLeftClicked, !1),
      ),
        this.controlsRight.forEach(
          (t) => t.removeEventListener(e, this.onNavigateRightClicked, !1),
        ),
        this.controlsUp.forEach(
          (t) => t.removeEventListener(e, this.onNavigateUpClicked, !1),
        ),
        this.controlsDown.forEach(
          (t) => t.removeEventListener(e, this.onNavigateDownClicked, !1),
        ),
        this.controlsPrev.forEach(
          (t) => t.removeEventListener(e, this.onNavigatePrevClicked, !1),
        ),
        this.controlsNext.forEach(
          (t) => t.removeEventListener(e, this.onNavigateNextClicked, !1),
        ),
        this.controlsFullscreen.forEach(
          (t) => t.removeEventListener(e, this.onEnterFullscreen, !1),
        );
    });
  }
  update() {
    ...
    if (t) {
      ...
      i && s
        ? (e.prev && this.controlsUp.forEach((e) => {
          e.classList.add("fragmented", "enabled"),
            e.removeAttribute("disabled");
        }),
...
class M {
  ...
  bind() {
    this.Reveal.getConfig().progress && this.element &&
...
const H = (e, t) => {
  ...
  i.type = "text/javascript",
    ...
    i.defer = !1,
    i.src = e,
    "function" == typeof t && (i.onload = i.onreadystatechange = (e) => {
...
class D {
  ...
  loadAsync() {
    return this.state = "loaded",
      this.asyncDependencies.length && this.asyncDependencies.forEach((e) => {
        H(e.src, e.callback);
      }),
      Promise.resolve();
  }
  registerPlugin(e) {
    ...
    "string" != typeof t
      ...
      ? (this.registeredPlugins[t] = e,
        "loaded" === this.state && "function" == typeof e.init &&
        e.init(this.Reveal))
      : console.warn(
...
class F {
  ...
  update() {
    ...
    const e = this.Reveal.getSlidesElement().querySelectorAll(
        this.iframeTriggerSelector,
      ).length > 0,
      t = this.Reveal.getSlidesElement().querySelectorAll(
  ...
  previewIframe(e) {
    this.close(),
      ...
      this.dom.querySelector("iframe").addEventListener("load", (e) => {
        ...
        n > 40 && Math.abs(n) > Math.abs(r)
          ? (this.touchCaptured = !0,
            "linear" === t.navigationMode
              ? t.rtl ? this.Reveal.next() : this.Reveal.prev()
              : this.Reveal.left())
          : n < -40 && Math.abs(n) > Math.abs(r)
          ? (this.touchCaptured = !0,
            "linear" === t.navigationMode
              ? t.rtl ? this.Reveal.prev() : this.Reveal.next()
              : this.Reveal.right())
          : r > 40 && a.up
          ? (this.touchCaptured = !0,
            "linear" === t.navigationMode
...
class U {
  ...
  update() {
    this.Reveal.getConfig().showNotes && this.element &&
      this.Reveal.getCurrentSlide() && !this.Reveal.isScrollView() &&
      !this.Reveal.isPrintView() &&
      (this.element.innerHTML = this.getSlideNotes() ||
        '<span class="notes-placeholder">No notes on this slide.</span>');
  }
  updateVisibility() {
    this.Reveal.getConfig().showNotes && this.hasNotes() &&
      !this.Reveal.isScrollView() && !this.Reveal.isPrintView()
      ? this.Reveal.getRevealElement().classList.add("show-notes")
      : this.Reveal.getRevealElement().classList.remove("show-notes");
  }
  hasNotes() {
    return this.Reveal.getSlidesElement().querySelectorAll(
...
function $(n, o) {
  ...
  function Re(t) {
    ...
    _.wrapper.classList.remove(s.transition),
      ...
      ae.reset(),
      S && (S.destroy(), S = null),
      a > 1 && A.autoSlide && A.autoSlideStoppable &&
      (S = new W(
        _.wrapper,
  ...
  function Ie() {
    if (_.wrapper && !oe.isActive()) {
          ...
          "none" !== t.style.display &&
            (A.center || t.classList.contains("center")
              ? t.classList.contains("stack")
                ? t.style.top = 0
                : t.style.top = Math.max((i.height - t.scrollHeight) / 2, 0) +
                  "px"
              : t.style.top = "");
        }
        s !== X &&
      ...
      !function () {
        if (
          _.wrapper && !A.disableLayout && !oe.isActive() &&
          "number" == typeof A.scrollActivationWidth && "scroll" !== A.view
        ) {
          const e = Be();
  ...
  function Be(e, t) {
    ...
    return a.presentationWidth -= a.presentationWidth * A.margin,
      a.presentationHeight -= a.presentationHeight * A.margin,
      "string" == typeof a.width && /%$/.test(a.width) &&
      (a.width = parseInt(a.width, 10) / 100 * a.presentationWidth),
      "string" == typeof a.height && /%$/.test(a.height) &&
      (a.height = parseInt(a.height, 10) / 100 * a.presentationHeight),
      a;
  }
  function He(e, t) {
    "object" == typeof e && "function" == typeof e.setAttribute &&
  ...
  function Oe() {
    return !!v &&
      (!v.nextElementSibling && (!Fe(v) || !v.parentNode.nextElementSibling));
  }
  function Ve() {
    if (A.pause) {
  ...
  function Ke(e, i, s, a) {
    ...
    void 0 !== i || de.isActive() || (i = De(r[e])),
      g && g.parentNode && g.parentNode.classList.contains("stack") &&
      He(g.parentNode, h);
    const o = $.concat();
    $.length = 0;
    let l = c || 0, d = h || 0;
  ...
  function $e(e, t, i, s) {
    return e.hasAttribute("data-auto-animate") &&
      t.hasAttribute("data-auto-animate") &&
      e.getAttribute("data-auto-animate-id") ===
        t.getAttribute("data-auto-animate-id") &&
  ...
  function Ze({ includeFragments: e = !1 } = {}) {
    ...
    if (
      ...
      (t.length > 1 && (s.left = !0, s.right = !0),
        ...
        t.length > 1 && "linear" === A.navigationMode &&
  ...
  function et(e = v) {
    ...
    e: for (let s = 0; s < t.length; s++) {
      let a = t[s], n = a.querySelectorAll("section");
      ...
      !1 === a.classList.contains("stack") &&
        "uncounted" !== a.dataset.visibility && i++;
    }
    return i;
  }
  function tt(e) {
    ...
    if (!e && v) {
      if (v.querySelectorAll(".fragment").length > 0) {
        ...
        i = e && e.hasAttribute("data-fragment-index")
  ...
  function lt(e, t) {
    let i = st()[e], s = i && i.querySelectorAll("section");
      ...
      i
        ...
        : (G = A.autoSlide,
          ...
          t(v, "video, audio").forEach((e) => {
            e.hasAttribute("data-autoplay") && G &&
        ...
        (Q = setTimeout(() => {
          "function" == typeof A.autoSlideMethod ? A.autoSlideMethod() : bt(),
            ct();
        }, G),
          Z = Date.now()),
        S && S.setPlaying(-1 !== Q);
  ...
  function vt({ skipFragments: e = !1 } = {}) {
    ...
    A.rtl
      ? (de.isActive() || e || !1 === le.next()) && Ze().left &&
        Ke(c + 1, "grid" === A.navigationMode ? h : void 0)
      : (de.isActive() || e || !1 === le.prev()) && Ze().left &&
        Ke(c - 1, "grid" === A.navigationMode ? h : void 0);
  }
  function pt({ skipFragments: e = !1 } = {}) {
    if (O.hasNavigatedHorizontally = !0, re.isActive()) return re.next();
    A.rtl
      ? (de.isActive() || e || !1 === le.prev()) && Ze().right &&
        Ke(c - 1, "grid" === A.navigationMode ? h : void 0)
      : (de.isActive() || e || !1 === le.next()) && Ze().right &&
        Ke(c + 1, "grid" === A.navigationMode ? h : void 0);
  }
  ...
  function Et(e) {
    "running" === J && /section/gi.test(e.target.nodeName) &&
      (J = "idle",
        Pe({
  ...
  function At(e) {
    !1 === document.hidden && document.activeElement !== document.body &&
  ...
  function kt(e) {
    (document.fullscreenElement || document.webkitFullscreenElement) ===
        _.wrapper && (e.stopImmediatePropagation(),
        setTimeout(() => {
  ...
  const Ct = {
    ...
    initialize: function (e) {
      ...
      if (
        H = !0, _.wrapper = n, _.slides = n.querySelector(".slides"), !_.slides
    ...
    isVerticalStack: function (e = v) {
      return e.classList.contains(".stack") ||
